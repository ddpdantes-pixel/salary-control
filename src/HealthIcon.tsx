  ...
  const paths: ReactNode = name === 'calendar'
    ...
    : name === 'history'
      ...
      : name === 'settings'
        ...
        : name === 'droplet'
          ? <path className="health-icon-fill" d="M12 3s6 6.2 6 10.2a6 6 0 0 1-12 0C6 9.2 12 3 12 3Z" />
          : name === 'coffee'
            ? <><path className="health-icon-fill" d="M5 8h11v6a4 4 0 0 1-4 4H9a4 4 0 0 1-4-4Z" /><path d="M16 10h2a2 2 0 0 1 0 4h-2M7 4h8" /></>
            : name === 'checklist'
